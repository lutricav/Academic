...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Stylesheet: Created on </xd:b> Sep 24, 2014</xd:p>
            <xd:p><xd:b>Author:</xd:b>Timothy W. Cook</xd:p>
            <xd:p>Display the detailed description of data based on a CCD.</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <html>
        ...
        <body bgcolor="d4dadd">
            ...
            Information from the metadata section of the validating Concept Constraint Definition (CCD) 
            as defined by the knowledge modeler. For a visualization of the nesting structure for the data
            please refer to the <b>HTML form</b> that acccompanies the CCD distributed from the 
                <a href='http://www.ccdgen.com' target='_blank'>CCD-Gen</a>.</p>
    ...
    <xd:doc>
        <xd:desc>
            <xd:p>A table for displaying the CCD metadata.</xd:p>
        </xd:desc>
    </xd:doc>
    <xsl:template name="metadata">
    <table title="CCD Metadata" align="center" cellpadding="10" border="2" style="width:100%;font-size:12">
        <caption style="font-size:18;font-weight:bold">CCD Metadata</caption>
        <tr><th>Name</th><th>Content</th></tr>
        <tr><td><b>Title:</b></td> <td><xsl:value-of select="//dc:title"/></td></tr>
        <tr><td><b>CCD ID:</b></td> <td> <xsl:value-of select="//dc:identifier"/></td></tr>
    ...
    <xsl:template name="PcT">
        <table title="CCD complexTypes" align="center" cellpadding="10" border="2" style="width:100%;font-size:12">
